...
struct CBW g_sCBW;
struct CSW g_sCSW;
uint32_t volatile g_u32LbaAddress ;
...
//    g_u32StorageBase = 0x20000B80;
		g_u32StorageBase = 0x20002300;
}
        ...
        switch (g_sCBW.u8OPCode)
        {
						case UFI_READ_10:
						{
							  ...
							  g_u32LbaAddress = get_be32(&g_sCBW.au8Data[0]) * USBD_SECTOR_SIZE;
								...
								MSC_AckCmd(0);
							 //printf("x=%d\n",g_u32StorageBase+g_u32LbaAddress);
								readflag=1;
								break;
						}
						case UFI_WRITE_10:
						...
						case UFI_READ_FORMAT_CAPACITY:
						{
								...
								MSC_AckCmd(0);
								//printf("UFI_READ_FORMAT_CAPACITY\n");
								break;
						}
